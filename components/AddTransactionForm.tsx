    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select
            id="type"
            value={values.type || TransactionType.EXPENSE}
        ...
        {values.type === TransactionType.INCOME && (
          <div>
            ...
            {getFieldError('selectedMemberId') && (
              <p className="mt-1 text-sm text-red-600">{getFieldError('selectedMemberId')}</p>
            )}
          </div>
        )}
          ...
          <>
            <div>
              ...
              <input
                ...
                placeholder="Optional - enter donor's name"
              />
              {getFieldError('donorName') && (
                <p className="mt-1 text-sm text-red-600">{getFieldError('donorName')}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Optional - phone, email, or other contact"
              />
              {getFieldError('donorContact') && (
                <p className="mt-1 text-sm text-red-600">{getFieldError('donorContact')}</p>
              )}
            </div>
          </>
        )}
        ...
        <button
          ...
          className={`w-full font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
